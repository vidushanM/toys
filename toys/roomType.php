            ...
            <div class="hedder-up row">
                ...
                <div class="col-lg-6">
                    <div class="header-topic">
                        <h4 class="title clr text-center mb-lg-4 mb-md-4 mb-sm-4 mb-3">ROOMS AND MEALS</h4>
                    </div>
                </div>
                            ...
                            <ul class="navbar-nav ">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="nav-link" href="icon.html">Double</a>
                                        <a class="nav-link " href="typography.html">Duplex</a>
                                        <a class="nav-link " href="typography.html">Inrerconnecting</a>
                                        <a class="nav-link " href="typography.html">Cabana</a>
                                        <a class="nav-link " href="typography.html">Pent House</a>
                                        <a class="nav-link " href="typography.html">Single</a>
                                        <a class="nav-link " href="typography.html">Suite</a>
                                    </div>
                                </li>
                                <li class="nav-item">
                                    <a href="about.html" class="nav-link">Meal Types</a>
                                </li>

                                <li class="nav-item">
                                    <a href="about.html" class="nav-link">Seasonal</a>
                                </li>
                                <li class="nav-item">
                                    <a href="service.html" class="nav-link">Feactured</a>
                                </li>
                                <li class="nav-item">
                                    <a href="shop.html" class="button_container header_button ml-auto"><button class="btn btn-danger"><span>Register  now</span></button></a>
                                </li>
